  ...
  return (
    <div className="flex w-full flex-col rounded-lg bg-white p-6 text-justify font-ptmono dark:bg-grey">
      ...
      <p className="text-body whitespace-pre-line leading-relaxed text-black dark:text-white">
        ...
        necessidade de publicá-las. <br />
        Ao utilizar esta aplicação, você insere o texto do tuíte desejado, e a
        inteligência artificial realiza uma análise do conteúdo, identificando
        padrões e características que permitem fazer previsões acerca do
        engajamento esperado, tanto em termos de likes quanto de retweets.
        <br />
        Além disso, a aplicação oferece uma funcionalidade adicional de sugestão
        de otimização do texto. Com base em melhores práticas de engajamento nas
        redes sociais, a inteligência artificial gera uma versão aprimorada do
        tuíte, visando maximizar a interação do público. <br />
        Nosso objetivo com esta aplicação é ajudar você a melhorar sua
